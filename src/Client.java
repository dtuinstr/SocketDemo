...
public class Client {
    ...
    private static final String PROMPT_FORMAT = "%s:%d> ";
    private static final String END_PORMAT =
    ...
    public void start() throws UnknownHostException, IOException {
        System.out.printf(START_FORMAT, hostname, port);
        ...
        try (
            ...
            do {
                System.out.printf(PROMPT_FORMAT, hostname, port);
        ...
        System.out.printf(END_PORMAT, hostname, port);
    }
}
